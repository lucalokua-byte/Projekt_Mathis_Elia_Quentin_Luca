...
#         # Check if classifier was loaded successfully
...
#         # Clean up the text (keep only alphanumeric characters)
...
#                 cv2.putText(frame_resized, "Extracted Text: " + plate_text, (x, y - 5), 
#                            cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
                
#                 return frame_resized, plate_text
        
#         # If no plates detected, just resize the frame
...
#         print("Number Plate Recognition started. Press 'q' to quit.")
...
#                 # Process the frame
#                 processed_frame, plate_text = self.process_frame(frame)
...
#         print("Number Plate Recognition stopped.")
...
#         # Confidence settings
#         self.confidence_threshold = confidence_threshold  # Minimum confidence level (0.0 to 1.0)
#         self.min_plate_length = min_plate_length
#         self.max_plate_length = max_plate_length
        
#         # Store confirmed plates
#         self.confirmed_plates = {}
#         self.confirmation_count_threshold = 3  # Number of consecutive detections needed
...
#             # Only consider alphanumeric characters with reasonable confidence
...
#         # Common license plate patterns (adjust based on your country)
#         patterns = [
#             r'^[A-Z0-9]{4,8}$',  # Basic alphanumeric plates
#             r'^[A-Z]{2,3}\d{1,4}$',  # Letters followed by numbers
#             r'^\d{1,4}[A-Z]{2,3}$',  # Numbers followed by letters
#             r'^[A-Z]\d{1,3}[A-Z]{1,3}$',  # Mixed format
#         ]
...
#             # Determine color and status based on confidence and confirmation
...
#             # Display plate text with confidence
...
#             if data['count'] < 2:  # Remove plates with only 1 detection
...
#         print("Press 'q' to quit, 'r' to reset confirmed plates")
...
#                 # Print confirmed plates to console
#                 if confirmed:
...
#                 # Clean up confirmed plates tracking periodically
#                 frame_count += 1
...
# # Create and run the recognizer
# if __name__ == "__main__":
#     # You can adjust the confidence threshold here (0.0 to 1.0)
#     recognizer = NumberPlateRecognizer(
